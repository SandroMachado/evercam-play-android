...
public class KeenHelper
{
    public static KeenClient getClient(Context context)
    {
        ...
        KeenProject keenProject = new KeenProject(
                propertyReader.getPropertyStr(PropertyReader.KEY_KEEN_PROJECT_ID),
                propertyReader.getPropertyStr(PropertyReader.KEY_KEEN_WRITE_KEY),
                propertyReader.getPropertyStr(PropertyReader.KEY_KEEN_READ_KEY));
