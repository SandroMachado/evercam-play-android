...
{
    /**
     * This method is called by native vout to request a surface resize when frame size doesn't
     * match surface size.
     *
     ...
     */
    void setSurfaceSize(int width, int height, int visible_width, int visible_height,
