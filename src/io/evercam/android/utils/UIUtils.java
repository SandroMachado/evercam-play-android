...
public class UIUtils
{
	public static AlertDialog GetAlertDialog(Context ctx, String title, String message)
	{
		AlertDialog.Builder adb = new AlertDialog.Builder(ctx,
				io.evercam.android.R.style.ThemeDialog);// ,io.evercam.android.R.style.theme_devicedefault_dialog_borderless);
		adb.setTitle(title);
	...
	{
		AlertDialog.Builder adb = new AlertDialog.Builder(ctx,
				io.evercam.android.R.style.ThemeDialog);// ,io.evercam.android.R.style.theme_devicedefault_dialog_borderless);//.Theme_DeviceDefault_Dialog);
	...
	{
		AlertDialog.Builder adb = new AlertDialog.Builder(ctx,
				io.evercam.android.R.style.ThemeDialogNoTitle);// ,io.evercam.android.R.style.theme_devicedefault_dialog_borderless);
