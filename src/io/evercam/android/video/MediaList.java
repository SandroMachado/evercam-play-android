...
public class MediaList
{
	...
	// private LibVLC mLibVLC; // Used to create new objects that require a
	// libvlc instance
	...
	// signal_list_event(EventHandler.CustomMediaListItemAdded, position,
	// media.getLocation());
	// }
	//
	// /**
	...
	// signal_list_event(EventHandler.CustomMediaListItemDeleted, position,
	// uri);
	// }
	//
