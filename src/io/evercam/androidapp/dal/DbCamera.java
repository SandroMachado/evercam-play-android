...
public class DbCamera extends DatabaseMaster
{
	...
	public EvercamCamera getCamera(int id)
	{
		...
		Cursor cursor = db.query(TABLE_CAMERA,
				new String[] { KEY_ID, KEY_CAMERA_ID, KEY_CAMERA_NAME, KEY_OWNER, KEY_USERNAME,
						KEY_PASSWORD, KEY_TIMEZONE, KEY_VENDOR, KEY_MODEL, KEY_MAC,
						KEY_EXTERNAL_JPG_URL, KEY_INTERNAL_JPG_URL, KEY_EXTERNAL_RTSP_URL,
						KEY_INTERNAL_RTSP_URL, KEY_STATUS, KEY_HAS_CREDENTIAL, KEY_INTERNAL_HOST,
						KEY_EXTERNAL_HOST, KEY_INTERNAL_HTTP, KEY_EXTERNAL_HTTP, KEY_INTERNAL_RTSP,
						KEY_EXTERNAL_RTSP, KEY_REAL_OWNER, KEY_CAN_EDIT, KEY_CAN_DELETE }, KEY_ID
