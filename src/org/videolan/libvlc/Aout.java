...
{
	/**
	 * Java side of the audio output module for Android. Uses an AudioTrack to
	...
	public void init(int sampleRateInHz, int channels, int samples)
	{
		...
		mAudioTrack = new AudioTrack(AudioManager.STREAM_MUSIC, sampleRateInHz,
				AudioFormat.CHANNEL_OUT_STEREO, AudioFormat.ENCODING_PCM_16BIT, Math.max(
						minBufferSize, channels * samples * 2), AudioTrack.MODE_STREAM);
	}
